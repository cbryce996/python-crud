...
from .fixtures import mock_repo_data, mock_user_data
...
@patch.object(
    github,
    "get",
    side_effect=[MagicMock(data=mock_user_data), MagicMock(data=mock_repo_data)],
)
@patch.object(
    github, "authorized_response", return_value={"access_token": "fake_token"}
)
